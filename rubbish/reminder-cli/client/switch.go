...
func (s Switch) create() func(string) error {
	return func(cmd string) error {
		...
		fmt.Println("reminder created succsecfully:\n%s", string(res))
		return nil
	}
}
...
func (s Switch) edit() func(string) error {
	return func(cmd string) error {
		...
		fmt.Println("reminder edited succsecfully:\n%s", string(res))
		return nil
	}
}
...
func (s Switch) fetch() func(string) error {
	return func(cmd string) error {
		...
		fetchCmd.Var(&ids, "id", "list of reminder Ids (int) to delete")
		...
		fmt.Println("reminders fetched succsecfully:\n%s", string(res))
		return nil
	}
}
...
func (s Switch) delete() func(string) error {
	return func(cmd string) error {
		...
		fmt.Println("succsecfully deleted record(s):\n%v\n", ids)
		return nil
	}
}
...
func (s Switch) parseCmd(cmd *flag.FlagSet) error {
	...
	if err != nil {
		return wrapError("Could not parse'"+cmd.Name()+"' commandflags", err)
	}
	return nil
}
